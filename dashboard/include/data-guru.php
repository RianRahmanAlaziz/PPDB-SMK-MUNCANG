...
<div class="sidebar close">
  ...
  <div class="container">
       ...
       <a href="tambah-guru.php">
            <i class='bx bxs-user-plus left'></i>
       </a>
        <table class="table" border="1">
          ...
          <?php 
              $no = 1;
              $list_guru = mysqli_query($conn, "SELECT * FROM tb_guru LEFT JOIN tb_pelajaran USING (kode_pelajaran)");
              while($row = mysqli_fetch_array($list_guru)){ 
           ?>
            <tr>
              <td><?php echo $no++; ?></td>
              ...
              <td> 
              <a href="detail-guru.php?id=<?php echo  $row['id']; ?>">Detail</a>    ||    
              <a href="hapus-guru.php?id=<?php echo  $row['id']; ?>" onclick="return confirm('Apakah Anda Yakin Untuk Menghapus Ini?')">Hapus</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
